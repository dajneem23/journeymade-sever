...
//     const percentageChange = calculatePercentage(currentAmount, prevAmount);
//     const usdChange = currentUsdValue - prevUsdValue;
//     const usdPercentageChange = calculatePercentage(currentUsdValue, prevUsdValue);
...
//   const percentageChange = calculatePercentage(amount[0], amount[1]);
//   const usdChange = usdValue[0] - usdValue[1];
//   const usdPercentageChange = calculatePercentage(usdValue[0], usdValue[1]);
...
//     await saveTopHoldersStatistics(output as any);
//   } catch (e) {
