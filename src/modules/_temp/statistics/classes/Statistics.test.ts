...
describe('Statistics', () => {
  ...
  it('period_0: should return value', () => {
    const st = new Statistics(portfolios, {
      period: 0,
  ...
  it('period_3: should return value', () => {
    const st = new Statistics(portfolios, {
      period: 3,
      from_time: 1676848200,
      to_time: 1676854200,
  ...
  it('address: should return chains, pool_adapter_ids', () => {
    const st = new Statistics(portfolios, {
      period: 3,
      from_time: 1676848200,
      to_time: 1676854200,
    ...
    expect(st.value).toEqual({
      period: 3,
      amount: 711443.393,
      usd_value: 1064319.316,
      price: 1.496,
      from_time: 1676848200,
      to_time: 1676854200,
      percentage_change: 0,
      usd_percentage_change: -0.401,
      chains: 'matic,eth',
