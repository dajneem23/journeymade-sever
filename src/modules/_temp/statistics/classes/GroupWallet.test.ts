  ...
  '0': [
    {
      ...
      ref_id: null,
      symbol: 'MATIC',
      address: '0x274e5361ee2c3c881da3ffe1e3b759bfecb632bc',
      amount: 711975.383,
    ...
    },
    {
      ...
      ref_id: null,
      symbol: 'MATIC',
      address: '0x9fdee27d8a418685f6855066923e57b5de4b5672',
      amount: 582571.046,
    ...
    },
    {
      ...
      ref_id: 'matic-0',
      symbol: 'MATIC',
      address: '0xcb5cea9e0000e02552f520f401d1f6793814c1e2',
      amount: 49588.662,
  ...
  it('should return value', () => {
    const groupWallet = new GroupWallet({
      ...
      addresses: [
        ...
        '0xcb5cea9e0000e02552f520f401d1f6793814c1e2',
      ],
      filters: {
        symbol: 'MATIC',
        cid: 2023022001,
    ...
    const result = groupWallet.value;
    ...
    expect(result.statistics?.length).toEqual(5);
    expect(result.wallets?.length).toEqual(2);
    expect(result.wallets[0]?.statistics).toEqual([{"amount": 607511.647, "chains": "eth", "from_time": 1676848200, "percentage_change": null, "period": 0, "price": 1.488, "to_time": 1676854200, "usd_percentage_change": null, "usd_value": 903977.331}, {"amount": 607511.647, "chains": "eth", "from_time": 1676837400, "percentage_change": 0, "period": 3, "price": 1.493, "to_time": 1676843400, "usd_percentage_change": -0.335, "usd_value": 907014.889}, {"amount": 607511.647, "chains": "eth", "from_time": 1676826600, "percentage_change": 0, "period": 6, "price": 1.508, "to_time": 1676832600, "usd_percentage_change": -1.326, "usd_value": 916127.564}, {"amount": 607511.647, "chains": "eth", "from_time": 1676805000, "percentage_change": 0, "period": 12, "price": 1.506, "to_time": 1676811000, "usd_percentage_change": -1.195, "usd_value": 914912.54}, {"amount": 607511.647, "chains": "eth", "from_time": 1676761800, "percentage_change": 0, "period": 24, "price": 1.482, "to_time": 1676767800, "usd_percentage_change": 0.405, "usd_value": 900332.261}]);
  });
});
